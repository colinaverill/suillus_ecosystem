...
#save line.----
png('exp2_plot.png',width = 10, height = 5, units = 'in', res = 300)
...
mtext(expression('ug N added * (g soil)'^-1*''), side = 1, line = 2.5)
arrows(fert, diff.lo, fert, diff.hi, length=0.05, angle=90, code=3)
abline(h = 0, lty = 3)
mtext('Soil Respiration Response', side = 2, line = 4, cex = o.cex)

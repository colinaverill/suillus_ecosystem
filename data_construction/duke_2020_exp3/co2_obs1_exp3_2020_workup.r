...
#set output path.----
output.path <- duke_2020_exp3_obs1_co2_workup.path

#load data.-----
d <- read.csv(raw_CO2_obs1_exp.3_2020.path)
time <- read.csv(samp_times_CO2_obs1_exp.3_2020.path)
...
output <- d[,c('sample.ID','resp.plant','resp.soil')]
